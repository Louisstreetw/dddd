...
> **80% de tout copy banger vient de la VOIX RÉELLE du client**, pas du marketing inventé.
> Halbert : *"Ton client est ton meilleur copywriter."*

**Workflow obligatoire pour un hook / headline** :
1. Si Louis t'a donné des verbatims/reviews/citations → pioche-les en premier
2. Sinon → demande-lui : *"Tu as des reviews ou verbatims de ta cible que je peux utiliser ?"*
3. Si pas disponible, écris en t'inspirant des golden nuggets génériques (voir `copywriting/golden-nuggets.md`)
4. Refuse de sortir des phrases inventées génériques (LVL 1-2)
...
Tout ce qui touche au prix / promo / garantie : **demande à Louis** s'il
ne te l'a pas précisé. Ne JAMAIS inventer un terme commercial qui
n'existe pas (ex : "essai gratuit 30 jours") sans confirmation.
